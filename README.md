...
```
git clone https://gitflic.ru/project/zetfoxx/zahvat-kamery-i-izmerenie-izobrajeniya.git
cd zahvat-kamery-i-izmerenie-izobrajeniya
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/zetfoxx/zahvat-kamery-i-izmerenie-izobrajeniya.git
git clone
